package org.example.securityjvt.security;


import lombok.RequiredArgsConstructor;
import org.example.securityjvt.filter.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests().requestMatchers(GET, "/api/user/**").hasAnyAuthority("ROLE_SUPER_ADMIN");
        http.authorizeHttpRequests().requestMatchers(POST, "api/user/registration").hasAnyAuthority("ROLE_SUPER_ADMIN");
